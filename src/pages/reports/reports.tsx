  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
        <h1 className="text-3xl font-bold tracking-tight">{translations.reports}</h1>
        <div className="mt-4 sm:mt-0 flex gap-2">
          <Select value={timeRange} onValueChange={setTimeRange}>
            ...
            <SelectContent>
              ...
              <SelectItem value="quarter">{translations.lastQuarter}</SelectItem>
      ...
      <Tabs defaultValue="overview" className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <Card className="col-span-2">
                ...
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    <Tooltip 
                      ...
                      formatter={(value) => [`LKR ${value.toLocaleString()}`, translations.sales]}
                    />
                    <Area 
                      type="monotone" 
                      dataKey="value" 
              ...
              <CardFooter className="justify-between">
                <div>
                  <p className="text-sm text-muted-foreground">{translations.totalForPeriod}</p>
            ...
            <CardContent className="h-[300px]">
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  />
                  <Legend />
                  <Bar dataKey="in" name={translations.stockIn} fill="hsl(var(--chart-1))" radius={[4, 4, 0, 0]} />
                  <Bar dataKey="out" name={translations.stockOut} fill="hsl(var(--chart-2))" radius={[4, 4, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </CardContent>
            <CardFooter>
        ...
        <TabsContent value="sales">
          <Card>
            <CardHeader>
              <CardTitle>{translations.salesAnalytics}</CardTitle>
              <CardDescription>
                {translations.detailedSalesAnalytics}
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground text-center py-20">
                {translations.salesReportContent}
              </p>
            </CardContent>
          </Card>
        </TabsContent>
...
function ReportStatCard({ title, value, trend, trend_direction, description }: ReportStatCardProps) {
  return (
    <Card>
        ...
        <div className="flex flex-col">
          <div className="flex items-center justify-between">
            ...
            <Badge variant="outline" className="font-mono">
              ...
              <span className={`${trend_direction === 'up' ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
                {trend}
              </span>
            </Badge>
          </div>
